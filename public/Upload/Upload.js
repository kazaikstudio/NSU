...
const BACKEND_URL = window.location.hostname === 'localhost' 
  ? 'http://localhost:5500' 
  : 'https://nsu-backend.up.railway.app';


// --- 1. INITIALIZATION & EVENTS ---
window.addEventListener('DOMContentLoaded', () => {
    // Initial UI state fetch calls
    updateStorageBar();
    loadUserData();
    loadDriveMusic();

    // Audio File Picker listener
    ...
    if (dropZone && imagePicker) {
        // Prevent browser from opening images locally on drag drops
        ...
        // Intercept dropped graphic assets
