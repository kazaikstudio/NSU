...
const Features = () => {
  ...
  return (
    <main>
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 sm:gap-6 lg:gap-8">
            {PILLARS.map((pillar) => (
              <div
                key={pillar.id}
                className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-zinc-800/80 bg-zinc-900/60 p-6 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-amber-500/50 hover:bg-zinc-900/90 hover:shadow-xl hover:shadow-amber-500/10 sm:p-8"
              >
                <div className="space-y-4">
                  ...
                  <h3 className="text-xl font-bold tracking-wide text-white transition-colors group-hover:text-amber-400">
                    {pillar.title}
                  </h3>
                  ...
                  <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-zinc-800/80 bg-zinc-900/60 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-amber-500/50 hover:bg-zinc-900/90 hover:shadow-xl hover:shadow-amber-500/10">
                    ...
                    <div className="relative aspect-square overflow-hidden bg-zinc-950">
                      ...
                      <div className="absolute bottom-3 left-3 z-10">
                        <span className="inline-block rounded-full border border-amber-500/30 bg-zinc-950/80 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-amber-400 backdrop-blur-md sm:px-3 sm:py-1 sm:text-xs">
                          {member.role}
                        </span>
                      </div>
                    </div>
      ...
      <section className="relative mt-20">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-6 lg:gap-8">
            ...
            {/* Student Card 1 */}
            <div className="group relative flex flex-col overflow-hidden rounded-2xl border border-zinc-800/80 bg-zinc-900/60 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-amber-500/50 hover:bg-zinc-900/90 hover:shadow-xl hover:shadow-amber-500/10">
              <div className="relative aspect-4/5 w-full overflow-hidden bg-zinc-950">
                <Image
                  ...
                  className="object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105"
                />
                <div className="absolute inset-0 bg-linear-to-t from-zinc-950 via-zinc-950/40 to-transparent opacity-90 transition-opacity group-hover:opacity-85" />
      ...
      <section className="relative mt-20 mb-5">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
          {/* Glass Panel Container with Glow Background */}
          <div className="relative overflow-hidden rounded-3xl border border-zinc-800/80 bg-zinc-900/60 p-8 shadow-2xl backdrop-blur-md sm:p-12 lg:p-16">
            ...
            <div className="relative z-10 mx-auto max-w-3xl space-y-6 text-center">
              ...
              <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row sm:gap-6">
                ...
                <Link
                  href="/about"
                  className="inline-flex items-center justify-center rounded-xl border border-zinc-700/80 bg-zinc-800/50 px-8 py-3.5 text-base font-semibold text-white backdrop-blur-md transition-all duration-300 hover:border-zinc-500 hover:bg-zinc-800 hover:text-amber-400 active:scale-95"
                >
                  Learn More
                </Link>
              </div>
