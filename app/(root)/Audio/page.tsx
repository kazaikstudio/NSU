  ...
  return (
    <main className="px-4 py-8 max-w-9xl mx-auto text-primary">
          ...
          <div className="mt-2 mb-5 text-center sm:text-start flex flex-col items-center sm:items-start">
            ...
            <h3 className="text-sm sm:text-lg text-amber-400 mt-1 italic">&ldquo;If you can dream it, Noll can design, shoot, and store it.&rdquo;</h3>
          </div>

          <FeaturedAudioCards />

          <p className="mt-5 text-center text-sm text-secondry md:text-left">
          ...
          <div className="search-box mt-4">
            <input
              ...
              value={searchTerm}
              className="w-full rounded-xl border border-card1/20 bg-cardcl/80 px-4 py-3 text-primary placeholder-secondry focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500"
              onChange={(e) => filterTracks(e.target.value)}
            />
          </div>

          {/* Switch Buttons for All Music & All Artist */}
          <div className="flex items-center w-full mt-5 bg-cardcl/80 p-1.5 rounded-2xl border border-card1/20">
            <button
