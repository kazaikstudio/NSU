...
export default function About() {
  ...
  return (
    <div className="flex min-h-screen flex-col text-primary">
      ...
      <main className="relative flex-1 overflow-hidden py-12 sm:py-20 lg:py-32">
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
          <header className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="relative group lg:col-span-6">
              <div className="absolute -inset-1 rounded-3xl bg-linear-to-r from-amber-500 to-orange-600
            ...
            <div className="flex flex-col justify-center space-y-6 lg:col-span-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-4">
                <div className="text-center sm:text-left">
                  <div className="inline-flex items-center gap-2 rounded-full border border-card1/20 bg-card1/30 px-3.5 py-1.5 text-xs font-semibold uppercase tracking-wider text-text">
                    <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-Eltext" />
                    Welcome To Noll Studio Uganda
                  </div>
                </div>

                <h1 className="text-center text-3xl font-extrabold tracking-tight text-primary sm:text-left sm:text-5xl lg:text-6xl">
                  OUR CREATIVE{' '}
                ...
                <p className="text-center text-base font-normal leading-relaxed text-secondry sm:text-left sm:text-lg">
              ...
              <div className="flex flex-col gap-3.5 sm:flex-row sm:items-center sm:gap-4 pt-2">
                <a
                  ...
                  className="group flex items-center justify-center gap-2.5 rounded-xl bg-navlink px-6 py-3.5 text-sm font-semibold text-zinc-950 transition-all duration-300 hover:bg-amber-400 hover:shadow-lg hover:shadow-amber-500/20 active:scale-95"
                >
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2.5 rounded-xl border border-zinc-800 bg-Eltext/80 px-8 py-3.5 text-sm font-semibold text-Eltext1 backdrop-blur-sm transition-all duration-300 hover:border-zinc-700 hover:bg-zinc-800 hover:text-white active:scale-95"
                >
                  <svg
                    width="20"
                    height="20"
        ...
        <section className="container mx-auto mt-20 max-w-7xl px-4 sm:px-6 lg:px-8">
                  <div className="flex justify-center sm:justify-start">
                    <div className="flex w-full flex-wrap justify-center gap-2 rounded-2xl border border-card1/20 bg-cardcl/60 p-1.5 backdrop-blur-md sm:w-auto">
                      <button
                        type="button"
                        ...
                        className={`relative flex flex-1 items-center justify-center gap-2 rounded-xl px-4 py-3 text-xs font-semibold transition-colors duration-300 sm:flex-none sm:px-6 sm:text-sm ${
                          activeTab === 'spark' ? 'text-zinc-950' : 'text-secondry hover:text-primary'
                        }`}
                      >
                        {activeTab === 'spark' && (
                          <motion.div
                      ...
                      <button
                        ...
                        className={`relative flex flex-1 items-center justify-center gap-2 rounded-xl px-4 py-3 text-xs font-semibold transition-colors duration-300 sm:flex-none sm:px-6 sm:text-sm ${
                          activeTab === 'moment' ? 'text-zinc-950' : 'text-secondry hover:text-primary'
                        }`}
                      >
                        {activeTab === 'moment' && (
                          <motion.div
                  ...
                  {/* Dynamic Tab Panes */}
                  <div className="mt-2 rounded-3xl border border-card1/20 bg-cardcl/40 p-6 backdrop-blur-sm sm:p-8 md:p-12">
                    <AnimatePresence mode="wait">
                      {activeTab === 'spark' ? (
                        ...
                        >
                          ...
                          <div className="space-y-4 text-base leading-relaxed text-secondry sm:text-lg">
                            <p>
        ...
        <section className="relative overflow-hidden py-12 text-primary sm:py-16 lg:py-20">
                  <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2">
                      {STORAGE_ITEMS.map((item, index) => (
                        <div
                          key={index}
                          className="group relative rounded-2xl border border-card1/20 bg-cardcl/60 p-6 backdrop-blur-sm transition-all duration-300 hover:border-amber-500/50 hover:bg-cardcl hover:shadow-lg hover:shadow-amber-500/10 sm:p-8"
                        >
        ...
        <section className="relative overflow-hidden py-16 text-primary lg:py-24">
                  <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
                    <div className="space-y-4 text-center">
                      <h2 className="text-3xl font-extrabold tracking-tight text-primary sm:text-4xl lg:text-5xl">
                        ...
                        <div className="mt-12">
                          ...
                          >
                            {FOUNDERS.map((founder, index) => (
                              ...
                              >
                                <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-card1/20
                                  bg-cardcl/60 transition-all duration-500 hover:-translate-y-1 hover:border-amber-500/50 hover:bg-cardcl hover:shadow-xl hover:shadow-amber-500/10">
                                  <div className="relative aspect-4/5 overflow-hidden bg-cardcl">
                                    <Image
                                  ...
                                  <div className="flex flex-1 flex-col justify-between p-5 sm:p-6">
                                    <div className="space-y-2">
                                      <h3 className="text-lg font-bold tracking-wide text-primary transition-colors group-hover:text-amber-400 sm:text-xl">
                                        {founder.name}
                                      </h3>
                                      <span className="block text-xs font-semibold uppercase tracking-wider text-amber-500">
                                        {founder.role}
                                      </span>
                                      <p className="pt-2 text-xs leading-relaxed text-secondry sm:text-sm">
                                        {founder.description}
                                      </p>
                                    </div>
                                  </div>
        ...
        {/* Core Mission */}
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  <section className="group relative my-8 overflow-hidden rounded-3xl border border-card1/20 bg-cardcl/60 p-6 backdrop-blur-md transition-all duration-300 hover:border-amber-500/30 hover:bg-cardcl sm:p-8 md:p-12">
                    ...
                    <div className="relative space-y-4">
                      ...
                      <h3 className="text-2xl font-extrabold tracking-tight text-primary sm:text-3xl lg:text-4xl">
                        THE NOLL{' '}
                        <span className="bg-linear-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent">
                          PHILOSOPHY
                        </span>
                      ...
                      <p className="text-base leading-relaxed text-secondry sm:text-lg">
        ...
        {/* Visual Showcase */}
        <section className="relative my-16 text-primary sm:my-20">
                  <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
                          ...
                          >
                            {PORTFOLIO_ITEMS.map((item, index) => (
                              <div
                                ...
                                className="w-full shrink-0 snap-center px-1 sm:w-auto sm:shrink sm:snap-align-none sm:px-0"
                              >
                                <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-card1/20 bg-cardcl/60 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-amber-500/50 hover:bg-cardcl hover:shadow-xl hover:shadow-amber-500/10">
                                  <div className="relative aspect-square overflow-hidden bg-cardcl">
                                    ...
                                    <div className="absolute inset-0 bg-linear-to-t from-cardcl/80 via-transparent to-transparent opacity-60" />
                                  </div>

                                  <div className="flex flex-1 flex-col justify-between p-5">
                                    <div className="space-y-1">
                                      <h5 className="text-lg font-bold text-primary transition-colors group-hover:text-amber-400">
                                        {item.title}
                                      </h5>
                                      <span className="block text-xs font-semibold uppercase tracking-wider text-secondry">
                                        {item.tag}
                                      </span>
                                    </div>
                                  </div>
                  ...
                  <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
                    ...
                    <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                      {PRODUCTION_TOOLS.map((tool, index) => (
                        <div
                          key={index}
                          className="group relative flex items-center gap-4 rounded-2xl border border-card1/20 bg-cardcl/60 p-4 backdrop-blur-sm transition-all duration-300 hover:border-amber-500/50 hover:bg-cardcl hover:shadow-lg hover:shadow-amber-500/10"
                        >
                          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-amber-500/20 bg-cardcl font-mono text-lg font-bold text-amber-400 transition-colors group-hover:bg-amber-500 group-hover:text-card1">
                            {tool.icon}
                          </div>
                          <div className="space-y-0.5 overflow-hidden">
                            <h4 className="truncate text-base font-bold text-primary transition-colors group-hover:text-amber-400">
                              {tool.name}
                            </h4>
                            <span className="block truncate text-xs font-medium text-secondry">
                              {tool.category}
                            </span>
                          </div>
                        </div>
                      ...
                      {DEV_SERVICES.map((service, index) => (
                        <div
                          ...
                          className={`group relative overflow-hidden rounded-2xl border p-6 sm:p-8 backdrop-blur-sm transition-all duration-300 ${
                            service.highlighted
                              ? 'border-amber-500/50 bg-cardcl shadow-xl shadow-amber-500/10'
                              : 'border-card1/20 bg-cardcl/60 hover:border-amber-500/40 hover:bg-cardcl'
                          }`}
                        >
                          <div
                            className={`absolute left-0 top-0 h-full w-1.5 ${
                              service.highlighted ? 'bg-linear-to-b from-amber-400 to-orange-500' : 'bg-card1/30 group-hover:bg-amber-500/50'
                            }`}
                          />
                          ...
                          <div className="space-y-4 sm:pl-2">
                            ...
                            <p className="text-sm leading-relaxed text-secondry">
                              {service.description}
                            </p>

                            <div className="pt-2">
                              <span className="inline-block rounded-md border border-card1/20 bg-cardcl px-3 py-1 font-mono text-xs font-medium text-amber-400">
                                {service.tech}
                              </span>
                            </div>
                          </div>
                        ...
                        <div className="space-y-6 text-center">
                          ...
                          <div className="flex flex-wrap items-center justify-center gap-3.5 pt-2 sm:gap-4">
                            <a
                              ...
                              rel="noopener noreferrer"
                              title="Subscribe on YouTube"
                              className="flex items-center justify-center rounded-xl border border-red-500/20 bg-red-500/10 p-3 sm:gap-2.5 sm:px-5 sm:py-3 text-sm font-semibold text-red-400 transition-all duration-300 hover:scale-105 hover:border-red-500/50 hover:bg-red-500/20"
                            >
                            ...
                            <a
                              ...
                              className="flex items-center justify-center rounded-xl border border-blue-500/20 bg-blue-500/10 p-3 sm:gap-2.5 sm:px-5 sm:py-3 text-sm font-semibold text-blue-400 transition-all duration-300 hover:scale-105 hover:border-blue-500/50 hover:bg-blue-500/20"
                            >
                              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <a
                              ...
                              className="flex items-center justify-center rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-3 sm:gap-2.5 sm:px-5 sm:py-3 text-sm font-semibold text-emerald-400 transition-all duration-300 hover:scale-105 hover:border-emerald-500/50 hover:bg-emerald-500/20"
                            >
                              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <a
                              ...
                              className="flex items-center justify-center rounded-xl border border-pink-500/20 bg-pink-500/10 p-3 sm:gap-2.5 sm:px-5 sm:py-3 text-sm font-semibold text-pink-400 transition-all duration-300 hover:scale-105 hover:border-pink-500/50 hover:bg-pink-500/20"
                            >
                              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <a
                              ...
                              className="flex items-center justify-center rounded-xl border border-sky-500/20 bg-sky-500/10 p-3 sm:gap-2.5 sm:px-5 sm:py-3 text-sm font-semibold text-sky-400 transition-all duration-300 hover:scale-105 hover:border-sky-500/50 hover:bg-sky-500/20"
                            >
                              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <section className="relative text-primary">
                          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="mt-8 flex justify-center sm:justify-start">
                              <div className="flex w-full flex-wrap justify-center gap-4 rounded-2xl border border-card1/20 bg-cardcl/80 p-1.5 backdrop-blur-md sm:w-auto">
                                  ...
                                  <button
                                    ...
                                    className={`relative flex-1 rounded-xl px-4 py-2.5 text-xs font-semibold transition-colors duration-300 sm:flex-none sm:px-6 sm:text-sm ${
                                      activeTestimonialTab === item.id
                                        ? 'text-card1'
                                        : 'text-secondry hover:text-primary'
                                    }`}
                                  >
                                    {activeTestimonialTab === item.id && (
                                      <motion.div
                            ...
                            <div className="mt-2 rounded-3xl border border-card1/20 bg-cardcl/60 p-5 backdrop-blur-sm sm:p-8">
                              <AnimatePresence mode="wait">
                                {TESTIMONIALS.filter((t) => t.id === activeTestimonialTab).map((item) => (
                                  <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -10 }}
                                    transition={{ duration: 0.25 }}
                                    className="flex flex-col gap-6 md:flex-row md:items-center md:gap-8 lg:gap-10 md:text-left"
                                  >
                                    {/* User Avatar Container - Fits parent width on mobile with aspect ratio, fixed size on desktop */}
                                    <div className="w-full shrink-0 md:w-64 lg:w-72">
                                      <div className="relative aspect-square w-full overflow-hidden rounded-2xl border-2 border-amber-500/40 bg-cardcl shadow-xl md:h-64 lg:h-72">
                                        <Image
                                          src={item.imageSrc}
                                          alt={item.name}
                                          fill
                                    ...
                                    {/* Content Block (Positioned below the image on mobile) */}
                                    <div className="flex-1 space-y-3 text-center md:text-left md:pt-0">
                                      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                        <h5 className="text-xl font-bold tracking-wide text-amber-400 sm:text-3xl md:text-2xl">
                                          {item.name}
                                        </h5>
                                      ...
                                      <p className="text-sm leading-relaxed text-secondry sm:text-base md:text-base">
                                        {item.text}
                                      </p>
                                    </div>
                                  </motion.div>
      ...
      <footer className="border-t border-card1/20 bg-cardcl/90 text-secondry backdrop-blur-md">
              <div className="container mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-12">
                <div className="grid grid-cols-1 gap-10 text-center sm:text-left lg:grid-cols-12">
                  ...
                  <div className="space-y-4 lg:col-span-6">
                    ...
                    <p className="mx-auto max-w-xl text-sm leading-relaxed text-secondry lg:mx-0">
                  ...
                  <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-6">
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2 text-sm text-secondry">
                        <li>
                ...
                {/* Bottom Bar */}
                <div className="mt-12 border-t border-card1/20 pt-6 text-center text-xs text-secondry/80">
